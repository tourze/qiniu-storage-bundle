 ...
 * @internal
 */
#[CoversClass(BucketDayStatistic::class)]
final class BucketDayStatisticTest extends AbstractEntityTestCase
{
    /**
     * 创建被测实体的一个实例.
     */
    ...
    {
        yield 'time' => ['time', new \DateTimeImmutable('2023-01-01 00:00:00')];
