 ...
 * @internal
 */
#[CoversClass(BucketHourStatistic::class)]
final class BucketHourStatisticTest extends AbstractEntityTestCase
{
    /**
     * 创建被测实体的一个实例.
     */
    ...
    {
        return new BucketHourStatistic();
    }
    ...
    {
        yield 'time' => ['time', new \DateTimeImmutable('2023-01-01 10:00:00')];
